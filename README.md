...
```bash
curl -fsSL https://raw.githubusercontent.com/SamirAlRashid/SonarQube-Deploy/main/setup.sh | sudo bash
```

Or with a specific version:

```bash
curl -fsSL https://raw.githubusercontent.com/SamirAlRashid/SonarQube-Deploy/main/setup.sh | sudo bash -s 9.9.8.100196
```
